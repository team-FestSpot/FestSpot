...
function MainLayout({ children }) {
  ...
  return (
    <BoardContext.Provider value={{ currentBoard, onBoardChange: handleBoardOnChange, loading }}>
      <div css={s.layout}>
        <UpperSideBar />
        <PostSideBar currentBoard={currentBoard} onBoardChange={handleBoardOnChange} loading={loading}/>
        {children}
      </div>
